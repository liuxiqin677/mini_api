...
class UserAnimal(Base):
    ...
    name = Column(String(50), nullable=False, comment="动物名称（可自定义）")
    ...
    # 关系
    user = relationship("User", back_populates="user_animals")
    animal = relationship("Animal", back_populates="user_animals")
